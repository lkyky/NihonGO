...
import com.example.nihongo.databinding.FragmentBLesson2Pg4Binding;

import java.util.Locale;

public class BLesson2Pg4 extends Fragment {

    private FragmentBLesson2Pg4Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentBLesson2Pg4Binding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnSound.setOnClickListener(v -> speak("おねえさん"));
        btnSound2.setOnClickListener(v -> speak("おねえさん、おやすみなさい"));
