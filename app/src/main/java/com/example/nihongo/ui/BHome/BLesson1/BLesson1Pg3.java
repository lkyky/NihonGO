...
import com.example.nihongo.databinding.FragmentBLesson1Pg3Binding;

import java.util.Locale;

public class BLesson1Pg3 extends Fragment {

    private FragmentBLesson1Pg3Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentBLesson1Pg3Binding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnSound.setOnClickListener(v -> speak("さん"));
        btnSound2.setOnClickListener(v -> speak("さんにん"));
