...
import com.example.nihongo.databinding.FragmentTLesson2Pg2Binding;

import java.util.Locale;

public class TLesson2Pg2 extends Fragment {

    private FragmentTLesson2Pg2Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentTLesson2Pg2Binding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnSound.setOnClickListener(v -> speak("えき"));
        btnSound2.setOnClickListener(v -> speak("それはえきですか？"));
        ...
        btnBack.setOnClickListener(v -> {
            NavController navController = Navigation.findNavController(view);
            navController.navigate(R.id.TLesson2Fragment);
        });
