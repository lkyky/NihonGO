...
import com.example.nihongo.databinding.FragmentTLesson1Pg4Binding;

import java.util.Locale;

public class TLesson1Pg4 extends Fragment {

    private FragmentTLesson1Pg4Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentTLesson1Pg4Binding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnSound.setOnClickListener(v -> speak("すみません"));
        btnSound2.setOnClickListener(v -> speak("すみません、道を教えてください。"));
