...
import com.example.nihongo.databinding.FragmentTLesson1Pg3Binding;

import java.util.Locale;

public class TLesson1Pg3 extends Fragment {

    private FragmentTLesson1Pg3Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentTLesson1Pg3Binding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnSound.setOnClickListener(v -> speak("ありがとうございます"));
        btnSound2.setOnClickListener(v -> speak("ありがとう！助かりました！"));
