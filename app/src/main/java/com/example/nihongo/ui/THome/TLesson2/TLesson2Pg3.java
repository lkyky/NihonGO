...
import com.example.nihongo.databinding.FragmentTLesson2Pg3Binding;

import java.util.Locale;

public class TLesson2Pg3 extends Fragment {

    private FragmentTLesson2Pg3Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentTLesson2Pg3Binding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnSound.setOnClickListener(v -> speak("バステイ"));
        btnSound2.setOnClickListener(v -> speak("バス停は近いですか？"));
