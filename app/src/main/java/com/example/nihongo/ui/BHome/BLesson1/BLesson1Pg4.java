...
import com.example.nihongo.databinding.FragmentBLesson1Pg4Binding;

import java.util.Locale;

public class BLesson1Pg4 extends Fragment {

    private FragmentBLesson1Pg4Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentBLesson1Pg4Binding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnSound.setOnClickListener(v -> speak("し　よん"));
        btnSound2.setOnClickListener(v -> speak("しがつ"));
