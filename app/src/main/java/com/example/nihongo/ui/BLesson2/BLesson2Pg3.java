...
public class BLesson2Pg3 extends Fragment {
    ...
    private FragmentBLesson2Pg3Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentBLesson2Pg3Binding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnSound.setOnClickListener(v -> speak("おにいさん"));
        btnSound2.setOnClickListener(v -> speak("おにいさん、ありがとう"));
